...
import 'package:shop_app/Screens/category_details/category_details.dart';
import 'package:shop_app/Screens/product_detalis/product_details.dart';
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              icon: Icon(
                                MainCubit.get(context).favorites[model.id] ? Icons.favorite : Icons.favorite_border,
                                color: MainCubit.get(context).favorites[model.id] ? Colors.red : Colors.grey,
                                size: 25,
                              ),
                            ),
                          ],
